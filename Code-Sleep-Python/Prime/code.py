...
if __name__ == "__main__":
    ...
    print("Brute force: "+str(prime(range_from, range_to))+ "\n\n")
    print("Sieve of Eratosthenes:"+str(sieve_eratosthenes(range_to)) +"\n\n")
    print("Segmented Sieve:"+str(segmented_sieve(range_from, range_to)))
