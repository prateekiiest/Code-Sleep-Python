...
# (intensity rating increase for booster words)
B_INCR = 0.293
B_DECR = -0.293

# intensity rating increase for ALLCAPs to emphasize a word
C_INCR = 0.733

N_SCALAR = -0.74

# for removing punctuation using regular expressions
...
class SentimentIntensityAnalyzer(object):
    ...
    def __init__(self, lexicon_file="vader_lexicon.txt"):
        ...
        lexicon_full_filepath = join(dirname(_this_module_file_path_), lexicon_file)  #here we get the path of lexicon file
    ...
    def make_lex_dict(self):														
		...
		if line != '':
            		...
            		lex_dict[word.lower()] = float(measure)							#make dictionary of lexicon file... [(word,measure)]
        return lex_dict
